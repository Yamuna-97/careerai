          ...
          <div className="bg-surface rounded-2xl border border-outline-variant/40 shadow-sm p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
            ...
            <div className="space-y-4 max-w-xl">
              ...
              <p className="font-body-md text-on-surface-variant leading-relaxed">
                Choose to edit manually with our step-by-step editor, invoke the AI Studio to analyze and optimize against real job descriptions, or select from our library of 20+ ATS-friendly templates.
              </p>
              
              <div className="flex flex-wrap gap-3 pt-2">
                <Link
                  to="/resume/builder"
                  className="bg-primary text-on-primary px-5 py-2.5 rounded-lg font-label-md text-sm font-bold shadow-sm hover:opacity-90 transition-opacity"
                >
                  Go to Builder
                </Link>
                <Link
                  to="/resume/ai-studio"
                  className="bg-secondary text-white px-5 py-2.5 rounded-lg font-label-md text-sm font-bold shadow-sm hover:opacity-90 transition-opacity"
                >
                  Launch AI Studio
                </Link>
              </div>
